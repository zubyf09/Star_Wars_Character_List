...
class CharacterSearchAdapter(private val interaction: Interaction? = null) :
    ListAdapter<CharacterSearchModel, CharacterSearchAdapter.CharacterSearchVH>(
    ...
    override fun onBindViewHolder(holder: CharacterSearchVH, position: Int) =
