package com.trivago.challenge.characters.search
...
class CharacterSearchVMTest {
    ...
    //Mock the repo
    private val repo = mock<com.trivago.challenge.characters.networking.CharacterSearchContract.Repo>()
    ...
    private val charactersObs = mock<Observer<List<com.trivago.challenge.characters.model.CharacterSearchModel>>>()
