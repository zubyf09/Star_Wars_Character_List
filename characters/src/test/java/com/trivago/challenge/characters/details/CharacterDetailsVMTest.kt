...
class CharacterDetailsVMTest {
    ...
    //Mock the repo
    private val repo = mock<com.trivago.challenge.characters.networking.CharacterDetailsContract.Repo>()
    ...
    fun testSuccessfulRemoteLoad() {
        ...
        val detailsObs = mock<Observer<com.trivago.challenge.characters.model.CharacterDetailsModel>>()

        val expectedDetails = com.trivago.challenge.characters.model.CharacterDetailsModel(
            url = characterUrl,
            name = "Luke Skywalker",
            birthYear = "19BBY",
    ...
    private fun mockCharacterDetails(): com.trivago.challenge.characters.model.CharacterDetailsModel {
        return gson.fromJson(
                TestingUtils.getResponseFromJson("/details/character_details"),
                com.trivago.challenge.characters.model.CharacterDetailsModel::class.java
        )
    }

    private fun mockCharacterSpecies(): com.trivago.challenge.characters.model.SpeciesResponseModel {
        return gson.fromJson(
                TestingUtils.getResponseFromJson("/details/character_species"),
                com.trivago.challenge.characters.model.SpeciesResponseModel::class.java
        )
    }

    private fun mockCharacterHomeworld(): com.trivago.challenge.characters.model.HomeworldResponseModel {
        return gson.fromJson(
                TestingUtils.getResponseFromJson("/details/character_homeworld"),
                com.trivago.challenge.characters.model.HomeworldResponseModel::class.java
        )
    }

    private fun mockCharacterFilm2(): com.trivago.challenge.characters.model.FilmResponseModel {
        return gson.fromJson(
                TestingUtils.getResponseFromJson("/details/character_film_2"),
                com.trivago.challenge.characters.model.FilmResponseModel::class.java
        )
    }

    private fun mockCharacterFilm6(): com.trivago.challenge.characters.model.FilmResponseModel {
        return gson.fromJson(
    ...
    private fun mockCharacterSpeciesWithNoHomeworld(): com.trivago.challenge.characters.model.SpeciesResponseModel {
        return gson.fromJson(
    ...
    private fun film2Details() = com.trivago.challenge.characters.model.FilmDetailsModel(
    ...
    private fun film6Details() = com.trivago.challenge.characters.model.FilmDetailsModel(
